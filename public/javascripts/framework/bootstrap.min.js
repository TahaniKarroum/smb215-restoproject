...
+ function(a) {"use strict";
	...
	c.DEFAULTS = {
		...
		if (!this.transitioning && !this.$element.hasClass("in")) {
			...
			if (this.$element.trigger(c), !c.isDefaultPrevented()) {
				...
				var g = function(b) {
					return b && b.target != this.$element[0] ?
					void  this.$element.one(a.support.transition.end, a.proxy(g, this)) : (this.$element.removeClass("collapsing").addClass("collapse in")[f](""), this.transitioning = 0,
					void  this.$element.off(a.support.transition.end + ".bs.collapse").trigger("shown.bs.collapse"))
				};
		...
		if (!this.transitioning && this.$element.hasClass("in")) {
			...
			if (this.$element.trigger(b), !b.isDefaultPrevented()) {
				...
				var d = function(b) {
					return b && b.target != this.$element[0] ?
					void  this.$element.one(a.support.transition.end, a.proxy(d, this)) : (this.transitioning = 0,
	...
	c.RESET = "affix affix-top affix-bottom", c.DEFAULTS = {
		...
		var a = this.$window.scrollTop(), b = this.$element.offset();
		return this.pinnedOffset = b.top - a
	}, c.prototype.checkPositionWithEventLoop = function() {
		setTimeout(a.proxy(this.checkPosition, this), 1)
	}, c.prototype.checkPosition = function() {
		if (this.$element.is(":visible")) {
			var b = a(document).height(), d = this.$window.scrollTop(), e = this.$element.offset(), f = this.options.offset, g = f.top, h = f.bottom;
